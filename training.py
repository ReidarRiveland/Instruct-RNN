...
if __name__ == "__main__":
    ...
    parser.add_argument('--use_dropout', action='store_true', help='for use with slurm sbatch script, indexes the combination of seed and holdout tasks along with the model')
    ...
    for job in jobs: 
        ...
        if args.mode == 'decoder' or args.mode == 'd': 
            ...
            train_decoder(EXP_FOLDER, model, _seed, holdouts, args.use_holdouts, 
                            use_checkpoint = args.use_checkpoint, use_dropout = args.use_dropout, 
