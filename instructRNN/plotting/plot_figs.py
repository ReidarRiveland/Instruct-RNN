...
plot_avg_holdout_curve('7.20models', 'swap', [ 'simpleNet', 'bowNet_lin', 'bowNet', 'gptNetXL_tuned', 'sbertNet_lin_tuned'])
...
plot_scatter(sbertNet, ['Go', 'AntiGo', 'GoMod1', 'AntiGoMod1',  'GoMod2', 'AntiGoMod2'], dims=3, pcs=[0, 1, 2], num_trials=50)
plot_scatter(sbertNet, ['Go', 'AntiGo', 'GoMod1', 'AntiGoMod1',  'GoMod2', 'AntiGoMod2'], dims=3, pcs=[0, 1, 2], num_trials=50, rep_depth='full')

plot_scatter(sbertNet, ['MultiDM', 'AntiMultiDM', 'DMMod1', 'AntiDMMod1',  'DMMod2', 'AntiDMMod2'], dims=3, pcs=[0, 1, 2], num_trials=50)
