...
plot_avg_holdout_curve('7.20models', 'swap', ['sbertNet_lin_tuned', 'simpleNet', 'bowNet', 'gptNetXL'], seeds=range(1))
plot_avg_holdout_curve('7.20models', 'swap', ['sbertNet_lin_tuned', 'sbertNet', 'sbertNet_tuned', 'gptNetXL_tuned',
                                'bertNet', 'bertNet_tuned', 'clipNet', 'clipNet_tuned', 'simpleNet', 'bowNet', 'gptNetXL'], seeds=range(1))
...
plot_tuning_curve(sbertNet, ['Go', 'AntiGo', 'GoMod1', 'AntiGoMod1',  'GoMod2', 'AntiGoMod2',], 32, [140]*6, np.linspace(0, 2*np.pi, 100), num_repeats=1, smoothing=1)
