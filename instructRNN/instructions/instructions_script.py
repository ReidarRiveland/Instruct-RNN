...
train_instruct_dict['DelayAntiDM'] = ('maintain both stimuli in memory and choose the one with least intensity', 
...
train_instruct_dict['Dur1Mod2'] = ('attend only to the second modality and select the initial direction if it lasts for longer than the final direction otherwise do not respond', 
									...
									'pay attention only to the second modality and opt for the initial displayed direction if it has a longer duration than the final direction otherwise do not respond',
...
train_instruct_dict['COMP1'] = ('if the first stimulus is greater than the second stimulus respond to the first stimulus otherwise do not respond', 
                                ...
                                'if the earlier stimulus has greater strength than the latter stimulus respond in the first direction otherwise do not respond',   
