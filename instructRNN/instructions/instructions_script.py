...
train_instruct_dict['Dur1'] =('respond to the earlier direction if it lasts for longer than the final direction otherwise do not respond',
							...
							'select the initial orientation if it has a duration that is greater than the second orientation otherwise do not respond', 
							'opt for the initial stimulus if it is displayed for more time than the final stimulus otherwise do not respond', 
							'choose the earlier orientation if it has a greater duration than the latter orientation otherwise do not respond',
							'if the earlier stimulus is presented for longer than the second stimulus respond to the earlier stimulus otherwise do not respond', 
							'if the initial orientation is displayed for more time than the final orientation then choose the initial orientation otherwise do not respond', 
							'go in the first direction if it appears for a greater amount of time than the latter stimulus otherwise do not respond', 
							'select earlier direction if it appears for longer than the second direction otherwise do not respond', 
							...
							'if the duration of the earlier stimulus is greater than the duration of the final stimulus respond to the earlier stimulus otherwise do not respond', 
...
train_instruct_dict['Dur2'] = ('select the second direction if it lasts for longer than the initial direction otherwise do not respond', 
								'if the duration of the final orientation is greater than the duration of the first orientation respond to the second orientation otherwise do not respond', 
								'if the duration of the latter stimulus is greater than the duration of the earlier stimulus respond to the latter stimulus otherwise do not respond', 
								'pick the second direction if it has a duration that is greater than the first direction otherwise do not respond', 
								'choose the final direction if it is displayed for more time than the initial direction otherwise do not respond', 
								'opt for the latter orientation if it lasts for longer than the earlier orientation otherwise do not respond', 
								'if the final stimulus is presented for a longer time period than the initial stimulus then respond to the final stimulus otherwise do not respond', 
								'if the second direction is displayed for more time than the initial direction respond to the second direction otherwise do not respond', 
								...
								'if the duration of the latter direction is greater than the duration of the earlier direction respond to the latter direction otherwise do not respond', 
								'choose the final direction if it is presented for longer than the first direction otherwise do not respond', 
								'if the latter stimulus appears for more time than the earlier stimulus than select the second stimulus otherwise do not respond',
								'if the duration of the latter stimulus is greater than the duration of the earlier stimulus than respond to the latter stimulus otherwise do not respond',
								'choose the second direction if it lasts for a greater period of time than the initial direction otherwise do not respond'
								)

train_instruct_dict['MultiDur1'] = ('respond to the earlier direction if it has longer duration averaged over both modalities than the latter direction otherwise do not respond', 
                                ...
                                'opt for the earlier stimulus if it has a greater duration averaged both modalities than the latter stimulus otherwise do not respond', 
                                'if the initial orientation appears for longer than the second orientation when considered across both modalities then select that orientation otherwise do not respond', 
                                ...
                                'if the earlier direction appears for a longer period of time then the latter direction over both modalities then select that direction otherwise do  not respond', 
                                'choose the first stimulus if it has a greater duration than the final stimulus when considered over both modalities otherwise do not respond', 
                                'respond to the earlier direction if it is displayed for a greater period of time than the second direction averaged over both modalities otherwise do not respond', 
                                ...
                                'select the earlier orientation if it has a greater averaged duration over both modalities than the latter orientation otherwise do not respond'
                                )
...
train_instruct_dict['MultiDur2'] = ('respond to the second direction if it lasts for a longer period of time over both modalities than the first direction otherwise do not respond',
                                    'choose the latter direction if it has a greater duration than the earlier direction averaged across modalities otherwise do not respond', 
									'if the latter orientation appears for a longer period of time when combined over both modalities than the earlier direction choose the latter direction otherwise do not respond',
									'if the second stimulus has a greater duration than the initial stimulus combined over modalities than select the second stimulus otherwise do not respond', 
									'choose the latter direction if it is longer than the earlier direction averaged over both modalities otherwise do not respond', 
									...
									'if the time period of the final orientation lasts for longer than the earlier orientation when averaged over both modalities then respond to the final orientation otherwise do not respond', 
									...
									'if the duration of the latter direction averaged across both modalities is greater than the initial direction then choose the latter direction otherwise do not respond', 
									'if the final stimulus lasts for longer than the initial stimulus when combined over both modalities then select the final stimulus otherwise do not respond', 
									...
									'if the second stimulus has a duration which lasts for longer than the initial stimulus when combined across both modalities then select the second stimulus otherwise do not respond',
...
train_instruct_dict['AntiDur1'] = ('respond to the earlier direction if it has a shorter duration than the second direction otherwise do not respond',
                                  ...
                                  'if the earlier stimulus has a shorter duration than the latter stimulus then select the earlier stimulus otherwise do not respond',
                                  ...
                                  'pick the earlier direction if it lasts for less time than the latter direction otherwise do not respond',
                                  'go in earlier direction if it has a shorter duration than the latter direction otherwise do not respond',
                                  ...
                                  'respond to the first orientation if it is shorter than the second orientation otherwise do not respond', 
                                  'select the first direction if it has a shorter duration than the final direction otherwise do not respond', 
                                  'pick the earlier stimulus if it is displayed for less time than the second stimulus otherwise do not respond'
                                  )
...
train_instruct_dict['AntiDur2'] = ('respond to the final direction if it has a shorter duration than the first direction otherwise do not respond',
                                  'choose the latter stimulus if it is displayed for less time than the earlier stimulus otherwise do not respond',
                                  ...
                                  'opt for the final direction if it has a shorter duration than the earlier direction otherwise do not respond',
                                  ...
                                  'if the second direction has a shorter duration than the earlier direction select the second direction otherwise do not respond',
                                  ...
                                  'if the latter direction appears for less time than the earlier direction respond to the latter direction otherwise do not respond',
                                  'choose the final orientation if it is shorter than the earlier orientation otherwise do not respond', 
...
train_instruct_dict['AntiMultiDur1'] = ('respond to the earlier direction if it is displayed for a shorter amount of time than the second direction averaged over modalities otherwise do not respond',
                                  ...
                                  'choose the earlier stimulus if it is shorter than the final stimulus averaged over both modalities otherwise do not respond',
                                  'select the earlier direction if it is displayed for less time than the latter direction combined over both modalities otherwise do not respond',
                                  'if the earlier direction is displayed for less time than the final direction averaged over both modalities then opt for the earlier direction otherwise do not respond',
                                  'if the initial stimulus has a shorter duration than the latter stimulus considered over both modalities then pick the initial stimulus otherwise do not respond',
                                  ...
                                  'pick the earlier stimulus if it appears for less time considered over both modalities than the second stimulus otherwise do not respond', 
...
train_instruct_dict['AntiMultiDur2'] = ('select the final direction if it is shorter than the earlier direction averaged over both modalities otherwise do not respond', 
                                    ...
                                    'if the latter stimulus is displayed for less time combined over both modalities than the earlier stimulus then select the latter stimulus otherwise do not respond',
                                    ...
                                    'pick the final direction if it has a shorter duration averaged over both modalities than the earlier direction otherwise do not respond', 
                                    ...
                                    'respond to the latter direction if it is displayed for less time than the earlier direction combined over both modalities otherwise do not respond',
                                    ...
                                    'pick the final direction if it is shorter than the earlier direction averaged over both modalities otherwise do not respond')



train_instruct_dict['Dur1Mod1'] = ('attend to the first modality and choose the earlier direction if has a longer duration than the second direction otherwise do not respond',
									...
									'focus only on the first modality and opt for the initial direction if it has a greater duration than the latter direction otherwise do not respond', 
									'pay attention only to the first modality and if the earlier stimulus lasts for more time than the final stimulus then respond to the earlier stimulus otherwise do not respond', 
									...
									'if the first orientation is displayed for more time than the second orientation in the first modality then respond to the initial orientation otherwise do not respond', 
									'focus only on the first modality and opt for the earlier stimulus if it is presented for longer than the final stimulus otherwise do not respond', 
									'focus on the first modality and pick the earlier orientation if it appears for a greater period of time than the latter orientation otherwise do not respond', 
									'go in the initial direction if it has a greater duration than that of the second stimulus in the first modality otherwise do not respond', 
									'attend only to the first modality and choose the initial direction if is appears for more time than the final direction otherwise do not respond', 
									...
									'attend only to the first modality and pick the earlier orientation if it has a longer duration than the final orientation otherwise do not respond',
									'focus on the first modality and opt for the earlier direction if it lasts for longer than the second direction otherwise do not respond')
...
train_instruct_dict['Dur1Mod2'] = ('attend only to the second modality and select the initial direction if it lasts for longer than the second direction otherwise do not respond', 
									'if the earlier orientation is displayed for more time than the final direction in the second modality then respond to the earlier orientation otherwise do not respond',
									'attend only to the second modality and pick the earlier stimulus if it lasts for a greater period of time than the latter direction otherwise do not respond', 
									'pay attention only to the second modality and opt for the earlier direction if it has a longer duration than the final direction otherwise do not respond',
									...
									'if the duration of the earlier stimulus is longer than the duration of the latter stimulus in the second modality respond to the earlier stimulus otherwise do not respond', 
									...
									'attend to the second modality and if the duration of the initial stimulus is greater than that of the latter stimulus then respond to the initial direction otherwise do not respond', 
									...
									'attend only to the second modality and opt for the earlier direction if it lasts for longer than the latter direction otherwise do not respond')
...
train_instruct_dict['Dur2Mod1'] = ('attend only to the first modality and select the second direction if it lasts for a greater period of time than the first direction otherwise do not respond', 
									...
									'select the second direction if it is displayed for a greater period of time than the initial direction in the first modality otherwise do not respond', 
									'focus only on the first modality and pick the final orientation if it has a longer duration than the first direction otherwise do not respond', 
									...
									'if the duration of the final stimulus is longer than the earlier stimulus in the first modality then respond to the final stimulus otherwise do not respond', 
									...
									'focus only on the first modality and choose the final direction if it is longer than the earlier direction otherwise do not respond', 
									'attend to the first modality and opt for the final orientation if it lasts for longer than the initial orientation otherwise do not respond',
									'pay attention only to the first modality and choose the latter stimulus if it is displayed for a longer period of time than the earlier stimulus otherwise do not respond',
									'respond to the latter stimulus if it appears for a longer period of time than the earlier stimulus in the first modality otherwise do not respond',
									'attend to the first modality and respond to the latter orientation if it lasts for a greater period of time than the earlier orientation otherwise do not respond')
...
train_instruct_dict['Dur2Mod2'] = ('attend only to the second modality and respond to the final direction if it has a longer duration than the first direction otherwise do not respond', 
									'focus only on the second modality and choose the latter stimulus if it appears for a greater period of time than the earlier direction otherwise do not respond', 
									'if the latter orientation appears for a greater period of time than the initial orientation in the second modality then select the latter orientation otherwise do not respond',
									...
									'focus on the second modality and choose the final orientation if it lasts for longer than the earlier orientation otherwise do not respond', 
									'attend to the second modality and select the latter stimulus if it is displayed for a greater period of time than the earlier stimulus otherwise do not respond', 
									...
									'if the duration of the final direction is longer than the duration of the earlier direction in the second modality then respond to the final direction otherwise do not respond',
									'pay attention only to the second modality and if the final stimulus lasts for more time than the initial stimulus then respond to the second stimulus otherwise do not respond',
									...
									'attend only to the second modality and opt for the final stimulus if it lasts for a greater period of time than the initial stimulus otherwise do not respond', 
									'attend only to the second modality and select the latter orientation if it has a longer duration than the earlier orientation otherwise do not respond',
									'pick the second direction if it appears for more time than the initial direction in the second modality otherwise do not respond'
									)
...
train_instruct_dict['COMP1'] = ('if the first stimulus is greater than the second stimulus respond to the first stimulus otherwise do not respond', 
                                ...
                                'if the earlier stimulus has greater strength than the latter stimulus respond in the earlier direction otherwise do not respond',   
                                ...
                                'choose the earlier stimulus if it is presented with the greater intensity than the second otherwise do not respond',
                                ...
                                'if the earlier stimulus is more intense than the latter stimulus choose the earlier direction otherwise do not respond',
...
train_instruct_dict['COMP2'] = ('respond in the direction of the second stimulus if it has greater intensity than the first otherwise do not respond', 
                                ...
                                'when the latter stimulus has greater strength than the earlier select the final orientation otherwise do not respond', 
                                ...
                                'if the final stimulus has higher value than the earlier stimulus choose the final orientation otherwise do not respond', 
                                'select the latter stimulus direction if it is presented with greater strength than the first otherwise do not respond', 
                                'when the last stimulus is presented with more intensity than the earlier respond in the second direction otherwise do not respond', 
                                ...
                                'select the latter stimulus if it is presented with the higher intensity than the initial stimulus otherwise do not respond',
                                ...
                                'choose the latter stimulus if it is more intense than the the earlier stimulus otherwise do not respond',
                                'when the final stimulus is more intense than the first respond to the final stimulus otherwise do not respond',
                                'pick the latter stimulus if it has more intensity than the earlier otherwise do not respond')
...
train_instruct_dict['MultiCOMP1'] = ('respond to the first direction when it has greater strength on average than the second stimulus otherwise do not respond',
                                        'respond if the earlier direction has higher combined intensity over two modalities than the latter stimulus otherwise do not respond', 
                                        ...
                                        'choose the initial direction if the integrated strength across modalities is greater than the latter direction otherwise do not respond', 
                                        ...
                                        'if the combined intensity of the earlier direction is higher than the latter direction then respond to the earlier direction otherwise do not respond', 
                                        ...
                                        'pick the earlier direction if the average value is larger than the latter direction for both modalities otherwise do not respond', 
                                        ...
                                        'if the intensity of the earlier stimulus integrated over modalities is greater than the second respond in the first direction otherwise do not respond',
                                        ...
                                        'pick the earlier stimulus if it has greater joint intensity over both modalities than the latter otherwise do not respond')
...
train_instruct_dict['MultiCOMP2'] = ('respond in the second direction if it has larger overall strength over modalities than the first direction otherwise do not respond', 
                                        ...
                                        'respond in the latter direction when it has higher integrated value over modalities than the earlier direction otherwise do not respond', 
                                        ...
                                        'respond to the latter direction when it has larger combined value over modalities than the earlier direction otherwise do not respond', 
                                        'select the latter direction if the strength integrated over modalities is greater than the earlier direction otherwise do not respond', 
                                        ...
                                        'pick the latter direction if it has larger strength combined over modalities than the earlier direction otherwise do not respond',
                                        ...
                                        'choose the latter direction if it has stronger presentation averaged over modalities than the earlier direction otherwise do not respond',
...
train_instruct_dict['AntiCOMP1'] = ('respond to the first direction if it is weaker than the final direction otherwise do not respond', 
									...
									'if the earlier direction has less strength than the latter direction then select the earlier direction otherwise do not respond', 
									...
									'respond to the earlier orientation if it is weaker than the second orientation otherwise do not respond', 
									'select the earlier stimulus if it is presented with less intensity than the second stimulus otherwise do not respond',
									'choose the earlier direction if is has less strength than the latter direction otherwise do not respond'
									)
...
train_instruct_dict['AntiCOMP2'] = ('respond to the final direction if it is weaker than the initial direction otherwise do not respond', 
									...
									'if the latter stimulus is less intense than the earlier stimulus then respond to the latter stimulus otherwise do not respond', 
									'choose the latter orientation if it is displayed with lower intensity than the first orientation otherwise do not respond', 
									...
									'go in the latter direction if it has less strength than the earlier direction otherwise do not respond', 
									...
									'respond to the final stimulus if it is weaker than the earlier stimulus otherwise do not respond',
									'choose the latter direction if it is presented with lower intensity than the earlier direction otherwise do not respond',
									'if the final stimulus is weaker than the earlier stimulus respond to the final stimulus otherwise do not respond'
									)
...
train_instruct_dict['AntiMultiCOMP1'] = ('respond to the first direction if it is weaker averaged over both modalities than the final direction otherwise do not respond',
										'if the earlier orientation has less strength over both modalities than the latter orientation then select the earlier orientation otherwise do not respond', 
										...
										'pick the earlier direction if it has lower intensity than the second direction combined over both modalities otherwise do not respond', 
										...
										'if the earlier stimulus is presented with less intensity than the second stimulus averaged over both modalities then select the earlier stimulus otherwise do not respond', 
										...
										'select the earlier direction if it has less overall strength over both modalities than the second direction otherwises do not respond',
										...
										'respond to the earlier stimulus if it is presented with less combined strength over both modalities than the latter stimulus otherwise do not respond',
...
train_instruct_dict['AntiMultiCOMP2'] = ('respond to the latter direction if it is weaker averaged over both modalities than the earlier direction otherwise do not respond', 
										...
										'if the latter direction is displayed with less intensity combined over both modalities than the earlier direction then select the latter direction otherwise do not respond', 
										...
										'choose the final stimulus if it has lower overall strength over both modalities than the earlier stimulus otherwise do not respond', 
										...
										'if the second direction is presented with weaker intensity combined over both modalities than the earlier stimulus select the second direction otherwise do not respond', 
										'respond to the latter stimulus if it is weaker when combined over both modalities than the first stimulus otherwise do not respond',
										'if the latter orientation is displayed with less intensity averaged over both modalities than the earlier orientation then choose the latter orientation otherwise do not respond')

train_instruct_dict['COMP1Mod1'] = ('attend only to the first modality and respond to the earlier direction if is stronger than the latter stimulus otherwise do not respond', 
                                    ...
                                    'pay attention only to the first modality and select the earlier orientation if it is presented with greater intensity than the latter orientation otherwise do not respond', 
                                    ...
                                    'if the earlier stimulus has more intensity than the latter stimulus in the first modality then choose the first stimulus otherwise do not respond', 
                                    ...
                                    'if the earlier orientation has higher intensity than the latter orientation in the first modality then respond to the first orientation otherwise do not respond', 
                                    'pay attention only to the first modality and opt for the earlier direction if it has more strength than the second direction otherwise do not respond')

train_instruct_dict['COMP1Mod2'] = ('focus only on the second modality and select the first direction if it is stronger than the latter direction otherwise do not respond', 
                                    ...
                                    'select the earlier direction if it has more intensity than the latter direction in the second modality otherwise do not respond', 
                                    ...
                                    'choose the earlier direction if it is presented with greater strength than the final direction in the second modality otherwise do not respond', 
                                    ...
                                    'pick the earlier stimulus if it is stronger than the latter stimulus in the second modality otherwise do not respond', 
                                    'attend only to the second modality and select the earlier orientation if it has greater strength than the second orientation otherwise do not respond', 
                                    'choose the earlier direction if it has higher intensity than the final direction in the second modality otherwise do not respond', 
...
train_instruct_dict['COMP2Mod1'] = ('attend only to the first modality and select the latter direction if it is stronger than the first direction otherwise do not respond', 
                                    ...
                                    'focus only on the first modality and choose the second orientation if is presented more intensely than the earlier direction otherwise do not respond', 
                                    'pick the final direction if it is displayed with higher intensity than the earlier direction in the first modality otherwise do not respond', 
                                    'pay attention only to the first modality and select the latter stimulus if it is stronger than the initial stimulus otherwise do not respond', 
                                    'if the second orientation is greater than the earlier orientation in the first modality then respond to the second orientation otherwise do not respond', 
                                    'select the latter stimulus if it is presented with higher strength than the earlier stimulus in the first modality otherwise do not respond', 
                                    'if the final orientation is stronger than the earlier orientation in the first modality than choose the last orientation otherwise do not respond', 
                                    'focus only on the first modality and go in the second direction if it is presented with higher intensity than the initial direction otherwise do not respond', 
                                    'respond to the latter stimulus if it has greater strength than the first stimulus in the first modality otherwise do not respond', 
...
train_instruct_dict['COMP2Mod2'] = ('focus only on the second modality and select the latter direction if it is stronger than the first direction otherwise do not respond',
                                    'select the final direction if it is greater than the earlier direction in the second modality otherwise do not respond', 
                                    'pay attention only to the second modality and pick the final orientation if it has higher intensity than the earlier orientation otherwise do not respond', 
                                    ...
                                    'select the latter orientation if it is displayed more intensely than the earlier orientation in the second modality otherwise do not respond',
                                    'if the final stimulus is greater than the first stimulus in the second modality than respond to the first stimulus otherwise do not respond', 
                                    ...
                                    'choose the latter stimulus if it has higher intensity than the initial stimulus in the second modality otherwise do not respond', 
                                    'attend only to the second modality and select the final direction if it has higher intensity than the earlier direction otherwise do not respond', 
                                    'if the latter stimulus is stronger than the earlier stimulus in the second modality respond to the latter stimulus otherwise do not respond')
